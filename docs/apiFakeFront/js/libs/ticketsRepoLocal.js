...
function buildSeedTickets() {
  ...
  return normalizeTickets([
    {
      id: makeId(),
      equipment: "Monitor Multiparamétrico - Leito 04",
      userName: "Enf. Marina",
      description: "Tela apagada e sem sinal de boot após troca de plantão.",
      status: "open",
      solution: null,
    ...
    {
      id: makeId(),
      equipment: "Workstation PACS 02",
      userName: "Téc. Fernando",
      description: "Lentidão extrema ao carregar imagens de ressonância.",
      status: "open",
      solution: null,
